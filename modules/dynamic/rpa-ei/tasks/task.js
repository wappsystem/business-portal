...
var parameters=_mobj.op.sys.config.parameters;
var panel=_mobj.op.panel;
var participant_tid	=$vm.module_list[ids.participant].table_id;
var notes_tid		=$vm.module_list[ids.task_notes].table_id;
var site_filter_tid	='';
    ...
    switch(field){
        ...
        case 'NT':
            ...
            td.find('u').on('click',function(){
				...
				$vm.load_module_by_name(ids.task_notes, $vm.root_layout_content_slot, op)
            });
            break;
    }
}
